...
return array(
  ...
  'preview-sizer-abbr-lg' => __( 'LG', '__x__' ),
  'preview-sizer-abbr-md' => __( 'MD', '__x__' ),
  'preview-sizer-abbr-sm' => __( 'SM', '__x__' ),
  'preview-sizer-abbr-xs' => __( 'XS', '__x__' ),
  'preview-sizer-desc-xl'  => __( '1200px &amp; Up', '__x__' ),
  'preview-sizer-desc-lg'  => __( '980px-1199px', '__x__' ),
  'preview-sizer-desc-md'  => __( '768px-979px', '__x__' ),
  'preview-sizer-desc-sm'  => __( '481px-767px', '__x__' ),
  'preview-sizer-desc-xs'  => __( '480px &amp; Smaller', '__x__' ),
  ...
  'global-blocks.title' => __( 'Global Blocks', '__x__' ),

  'template-manager.title'       => __( 'Template Manager', '__x__' ),
  'design-cloud.title'           => __( 'Design Cloud', '__x__' ),
  'font-manager.title'           => __( 'Font Manager', '__x__' ),
  'color-manager.title'          => __( 'Color Manager', '__x__' ),
  'element-manager.title'        => __( 'Element Manager', '__x__' ),
  'template-manager-short.title' => __( 'Template', '__x__' ),
  'font-manager-short.title'     => __( 'Font', '__x__' ),
  'color-manager-short.title'    => __( 'Color', '__x__' ),
  'element-manager-short.title'  => __( 'Element', '__x__' ),
  ...
  'elements.nothing-found'     => __( 'No Elements Found', '__x__' ),
  'elements.nothing-found-msg' => __( 'Try refining your search to locate your desired element.', '__x__' ),
  ...
  'controls-tooltip-top' => __( 'Top', '__x__' ),
  'controls-tooltip-right' => __( 'Right', '__x__' ),
  'controls-tooltip-bottom' => __( 'Bottom', '__x__' ),
  'controls-tooltip-left' => __( 'Left', '__x__' ),
  ...
  'assignments.unassigned'           => __( 'Unassigned', '__x__' ),
  'assignments.tagged'               => __( '{{tag}}: {{title}}', '__x__' ),
  ...
  // Options
  'options.launch-headers' => __( 'Launch Header Builder', '__x__' ),
  'options.launch-footers' => __( 'Launch Footer Builder', '__x__' ),
  'options.confirm-header-switch-back' => __( 'Are you sure you wish to switch back to Original Headers? This will unassign remove your global Pro Header.', '__x__' ),
  'options.confirm-footer-switch-back' => __( 'Are you sure you wish to switch back to Original Footers? This will unassign remove your global Pro Footer.', '__x__' ),
  ...
  'templates.download-label' => array(
    'one' => __( 'Download Template', '__x__'),
    'other' => __( 'Download {{count}} Templates', '__x__'),
  ),

  'templates.delete-label' => array(
    'one' => __( 'Delete Template', '__x__'),
    'other' => __( 'Delete {{count}} Templates', '__x__'),
  ),

  'templates.delete-popover' => array(
    'one' => __( 'Are you sure you want to delete the selected template?', '__x__'),
    'other' => __( 'Are you sure you want to delete the {{count}} selected templates?', '__x__'),
  ),
  ...
  'templates.design-cloud'   => __( 'Design Cloud', '__x__'),
  ...
  'templates.element-defaults-save' => __( 'Element defaults updated!', '__x__' ),
  'templates.element-defaults-error' => __( 'Unable to save element default.', '__x__' ),

  // Fonts
  'fonts.new-title' => __( 'Font {{index}}', '__x__' ),

  // Colors
  'colors.new-title' => __( 'Color {{index}}', '__x__' ),
  'colors.empty-message' => __( 'Click "Add New" to create a color selection.', '__x__' ),
  ...
  // Preferences
  'preferences.title'          => __('Preferences', '__x__'),
  ...
  'preferences.saved'          => __('Preferences saved!', '__x__'),
  'preferences.save-error'     => __('Unable to save preferences.', '__x__'),
