...
class Cornerstone_Element_Definition {
  ...
  public function is_private() {
    return ( isset( $this->def['options']['private'] ) && $this->def['options']['private'] ) || $this->is_child_or_classic_child() || 'classic:undefined' === $this->type;
  }
  ...
  public function serialize() {
    ...
    $data = array(
      ...
      'valid-children' => $this->def['valid_children'],
  ...
  public function save( $data, $content, $atts = array(), $depth = 0 ) {
    ...
    if ( $depth > 1 && in_array( $data['_type'], apply_filters( 'cs_nested_element_types', array( 'row', 'column' ) ), true ) ) {
      $tag .= "_$depth";
    }
  ...
  public function type_is_layout( $type ) {
    return in_array(
      ...
      array( 'bar', 'container', 'section', 'row', 'column', 'grid', 'cell' )
    );
  }
